const fs = require('fs-extra') 
 ...
 //═══════[Required Variables]════════\\ 
 global.owner = process.env.OWNER_NUMBER.split("12045211808") 
 ...
 global.sudo = process.env.SUDO || '12045211808' 
 global.devs = '12045211808'; 
 ...
 module.exports = { 
   botname:   process.env.BOT_NAME === undefined ? 'King-zidi' : process.env.BOT_NAME, 
   ownername: process.env.OWNER_NAME === undefined ? 'Malik' : process.env.OWNER_NAME,  
